...
public interface Logger {
	...
	// 		b. The error method on the AsteriskLogger should print the String it
	//		   receives inside a box of asterisks, with the String preceded by the
	//		   word “ERROR:”. For example, if “Hello” is the argument, the following
	//		   should be printed:
	...
	// 		a. If the log method received “Hello” as an argument, it should
	//		   print H e l l o

	
	// 		b. The error method should do the same, but with “ERROR:” preceding
	//		   the spaced out input (i.e. ERROR: H e l l o)


	// 6.  Create a class named App that has a main method.

	// 		a.  In this class instantiate an instance of each of your logger
	//			classes that implement the Logger interface.

	// 		b. Test both methods on both instances, passing in Strings of
	//		   your choice.
